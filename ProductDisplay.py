...
def display_product_info(id,return_frame):
    ...
    product_frame_style.configure("display.TFrame", background="white")
    ...
    product_name=ttk.Label(product_display_frame,text="{}".format(rows[0][1]),font=('Segoe UI Light',27),background="White")
    product_name.place(x=700,y=10,anchor="nw")

    price=ttk.Label(product_display_frame,text="Rs {} Npr".format(rows[0][3]),font=('Segoe UI Light',18),background="White")
    price.place(x=700,y=60,anchor="nw")

    description=ttk.Label(product_display_frame,text="{}".format(rows[0][2]),wraplength=390,font=('Segoe UI Light',14),background="White")
