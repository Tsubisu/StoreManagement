...
def home_bar_builder(frame):
    ...
    Order = ttk.Button(HomeBar, text="Orders",style="My.TButton", padding='0.1,0.1', takefocus=False, width=6,command=lambda:ps.bottom_page_switcher("Order"))
    Order.place(x=1120, y=80)
